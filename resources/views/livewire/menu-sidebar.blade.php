    ...
    <div x-on:click.away="open=false" class="flex bg-indigo-900 sticky top-0">
        <div class="container flex items-center h-20 justify-between ">
            ...
            <a x-on:click="open = !open" >
                <div class="flex flex-col items-center justify-center hover:text-indigo-400 text-green-400 cursor-pointer  font-semibold" >
            ...
            <div >
                ...
                <div class="flex flex-col items-center order-last justify-center text-green-400 cursor-pointer rounded-lg hover:text-indigo-400 font-semibold ">
