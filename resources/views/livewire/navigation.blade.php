...
<header class="sticky top-0" x-data="{ open: false}">
    ...
    <div x-on:click.away="open=false"
        class="flex bg-indigo-900 ">
        <div class="container flex items-center h-20 justify-between">
            <a x-on:click="open = !open"
                class=" hover:text-indigo-400 text-green-400 cursor-pointer sm:order-first">
        ...
        <nav :class="{ 'hidden' : !open }"
            class=" fixed w-full sm:w-80 top-0 bottom-0 lg:left-0 p-2 overflow-y-auto transition duration-700 ease-in  text-center bg-gray-900 hidden ">
                ...
                {{-- HOME --}}
                <div  class=" sm:hidden mt-6 flex items-center text-2xl rounded-md transition duration-500 ease-in cursor-pointer hover:bg-indigo-700">
                ...
                <div x-data ="{user : false}">
                    <a x-on:click = "user = !user">
                        <div  class=" mt-6 flex items-center text-2xl rounded-md transition duration-500 ease-in cursor-pointer hover:bg-indigo-700">
                            ...
                            <div x-ref="arrow" class="ml-2" :class="{'block' : user, 'rotate-180' : user,}" >
                ...
                <div x-data ="{note : false}">
                    <a x-on:click = "note = !note">
                        <div  class=" mt-6 flex items-center text-2xl rounded-md transition duration-500 ease-in cursor-pointer hover:bg-indigo-700">
                            ...
                            <div x-ref="arrow" class="ml-2" :class="{'block' : note, 'rotate-180' : note,}" >
                                <span class="text-xl text-gray-300 rotate-0">
                                    <i class="bi bi-chevron-down"></i>
                                </span>
                            </div>
                ...
                <div x-data ="{comment : false}">
                    <a x-on:click = "comment = !comment">
                        <div  class=" mt-6 flex items-center text-2xl rounded-md transition duration-500 ease-in cursor-pointer hover:bg-indigo-700">
                            ...
                            <div x-ref="arrow" class="ml-2" :class="{'block' : comment, 'rotate-180' : comment,}" >
                                <span class="text-xl text-gray-300 rotate-0">
                                    <i class="bi bi-chevron-down"></i>
                                </span>
                            </div>>
                ...
                <div x-data ="{reaction : false}">
                    <a x-on:click = "reaction = !reaction">
                        <div  class=" mt-6 flex items-center text-2xl rounded-md transition duration-500 ease-in cursor-pointer hover:bg-indigo-700">
                            ...
                            <div x-ref="arrow" class="ml-2" :class="{'block' : reaction, 'rotate-180' : reaction,}" >
                                <span class="text-xl text-gray-300 rotate-0">
                                    <i class="bi bi-chevron-down"></i>
                                </span>
                            </div>
                ...
                <div x-data ="{notification : false}">
                    <a x-on:click = "notification = !notification">
                        <div  class=" mt-6 flex items-center text-2xl rounded-md transition duration-500 ease-in cursor-pointer hover:bg-indigo-700">
                            ...
                            <div x-ref="arrow" class="ml-2" :class="{'block' : notification, 'rotate-180' : notification,}" >
                                <span class="text-xl text-gray-300 rotate-0">
                                    <i class="bi bi-chevron-down"></i>
                                </span>
                            </div>
