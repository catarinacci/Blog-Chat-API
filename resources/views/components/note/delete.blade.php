...
<div class="p-6 sm:px-6 lg:px-12  bg-indigo-200 border-b border-gray-400 ">
    ...
    <div class=" mt-5 overflow-auto">
        <div class="size ">
            <img src="https://note-api-catarinacci.s3.sa-east-1.amazonaws.com/noteapi/note_delete_token.jpg" alt="">
        </div>
    </div>
</div>
...
<div class="p-6 sm:px-6 lg:px-12  bg-indigo-200 border-b border-gray-400 ">
    ...
    <div class=" mt-5 overflow-auto bg-slate-100">
        ...
        <pre>
            <code data-lang="php" >
{
    <span style="color:red;">"res"</span>: <span style="color:blue;">"La publicación se bloqueó correctamente"</span>
}
            </code>
        </pre>
        </div>
