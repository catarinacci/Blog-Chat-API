<div class="p-6 sm:px-6 lg:px-12 sm:rounded-t-lg bg-white border-b border-gray-200">
    ...
    <div class="mt-6 mb-6 leading-7 text-gray-800">
       Permite al usuario Autenticado crear un comentario a una publicación.<br>
    </div>
    <div class=" flex mb-6 lg:mt-0 overflow-auto items-center bg-blue-100 rounded-lg ">
        ...
        <div>
            <p class=" ml-6 text-lg ">www.noteapi.ga/api/comment</p>
        </div>
</div>
...
<div class="p-6 sm:px-6 lg:px-12  bg-indigo-200 border-b border-gray-400 ">
    ...
    <div class=" mt-5 overflow-auto">
        <div class="size ">
            <img src="https://note-api-catarinacci.s3.sa-east-1.amazonaws.com/noteapi/comment_create_enviar.jpg" alt="">
        </div>
    </div>
    <div class="flex items-center">
    ...
    <div class=" mt-5 overflow-auto">
        <div class="size ">
            <img src="https://note-api-catarinacci.s3.sa-east-1.amazonaws.com/noteapi/comment_create_token.jpg" alt="">
        </div>
    </div>
