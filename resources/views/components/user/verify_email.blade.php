    ...
    <div class="p-6 sm:px-6 lg:px-12  bg-indigo-200 border-b border-gray-400 ">
        ...
        <div class=" mt-5 overflow-auto">
            <div class="size_token ">
                <img src="https://note-api-catarinacci.s3.sa-east-1.amazonaws.com/noteapi/verify_email_token.jpg"
                    alt="">
            </div>
        </div>
        <div class=" mt-5 overflow-auto">
            <div class="size ">
                <img src="https://note-api-catarinacci.s3.sa-east-1.amazonaws.com/noteapi/verify_email_code.jpg"
                    alt="">
            </div>
        </div>
