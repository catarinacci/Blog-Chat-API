<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-6 text-gray-500">
        NoteApi es un sistema que realiza los métodos básicos de una red social. Los mismos son registro de usuario, login,
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
     <div class="p-6">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="https://laravel.com/docs">Configuación inicial</a></div>
        </div>
